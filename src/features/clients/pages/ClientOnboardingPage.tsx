import { AdminStep } from '@features/clients/components/onboarding/AdminStep';
import { ClientDataStep } from '@features/clients/components/onboarding/ClientDataStep';
import { OnboardingSummary } from '@features/clients/components/onboarding/OnboardingSummary';
import { PlanStep } from '@features/clients/components/onboarding/PlanStep';
import { TenantStep } from '@features/clients/components/onboarding/TenantStep';
import { StepperWizard } from '@shared/components/navigation/StepperWizard';
import { AppPaper } from '@shared/components/data-display/AppPaper';
import { AppStack } from '@shared/components/layout/AppStack';
import { PageHeader } from '@shared/components/layout/PageHeader';
import { useClientOnboardingPageViewModel } from '@features/clients/hooks/useClientOnboardingPageViewModel';
...
const ClientOnboardingPage = () => {
  ...
  const sharedStepProps = {
    ...
    setUiExtras: model.form.setUiExtras,
  };
