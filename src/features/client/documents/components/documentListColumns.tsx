...
type DocumentListColumnsParams = {
...
const renderActions = (
  ...
  buildRowActions: (document: GeneratedDocument) => RowActionItem[],
) => (
  <RowActionsMenu
...
export const buildDocumentListColumns = ({
  buildRowActions,
}: DocumentListColumnsParams): DataTableColumn<GeneratedDocument>[] => [
  {
    key: 'title',
    header: 'Documento',
    render: getTitle,
...
export const buildDocumentMobileConfig = ({
  buildRowActions,
}: DocumentListColumnsParams): DataListMobileConfig<GeneratedDocument> => ({
