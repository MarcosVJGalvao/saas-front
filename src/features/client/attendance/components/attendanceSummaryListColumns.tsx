...
export const attendanceSummaryListColumns: DataTableColumn<AttendanceSummary>[] = [
  {
    key: 'student',
    header: 'Aluno',
...
export const attendanceSummaryMobileConfig: DataListMobileConfig<AttendanceSummary> = {
