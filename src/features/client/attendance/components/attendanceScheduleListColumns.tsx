...
export const attendanceScheduleListColumns: DataTableColumn<AttendanceSchedule>[] = [
  {
    key: 'class',
    header: 'Turma',
    render: getClassName,
...
export const attendanceScheduleMobileConfig: DataListMobileConfig<AttendanceSchedule> = {
