import { usePlatformChangePasswordPage } from '@features/platform/profile/hooks/usePlatformChangePasswordPage';
...
const PlatformChangePasswordPage = () => {
  const page = usePlatformChangePasswordPage();
...
export default PlatformChangePasswordPage;
